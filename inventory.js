...
function startInventorySort() {
    getInventorySortConfig(function(data) {
        ...
        if (!title && document.querySelector("frame[name='mainFrame']")) title = document.querySelector("frame[name='mainFrame']").contentWindow.document.querySelector("h1#shadow");
        if (!title) return;
        ...
        if (!itemPanelEquip && document.querySelector("frame[name='mainFrame']")) itemPanelEquip = document.querySelector("frame[name='mainFrame']").contentWindow.document.querySelector("div#profile");
        ...
        if (!itemPanelMisc && document.querySelector("frame[name='mainFrame']")) itemPanelMisc = document.querySelector("frame[name='mainFrame']").contentWindow.document.querySelector("div#home");
